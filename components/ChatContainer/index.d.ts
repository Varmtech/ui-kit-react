...
declare const SceytChatContainer: ({ client, avatarColors, children, showContactInfoOnUserList, sendAttachmentsAsSeparateMessages, logoSrc, CustomUploader, customColors }: IChatClientProps) => JSX.Element;
